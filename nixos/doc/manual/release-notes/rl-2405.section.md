...
- [Docuum](https://github.com/stepchowfun/docuum), a daemon that performs least-recently-used (LRU) eviction of Docker images to limit the storage they consume. Available as [services.docuum](#opt-services.docuum.enable).
